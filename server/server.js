...
const planReferrerRoutes = require('./routes/planReferrerRoutes');
app.use('/api/referrers', planReferrerRoutes); 
...
const io = require('socket.io')(server, {
    pingTimeout: 60000,
    cors: {
        origin: [process.env.CLIENT_URL, process.env.ADMIN_URL], // Use environment variables
        methods: ["GET", "POST"],
    },
});
