...
exports.createOrder = async (req, res) => {
    try {
        // 1. Get the user from the auth token, not the request body
        ...
        // 2. Create the Razorpay order with the plan's amount
        const options = {
            amount: plan.amount * 100, // Amount in paise
            currency: 'INR',
            receipt: `receipt_order_${user._id}_${new Date().getTime()}`,
        };
