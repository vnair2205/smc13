...
const VerifyEmailPage = () => {
            ...
            const options = {
                ...
                handler: async (response) => {
                    ...
                    try {
                        ...
                        // --- FIX: Check for the token before saving and navigating ---
    ...
    // NOTE: The "Change Email" functionality has been removed for simplicity
    // during this critical payment flow fix. It can be added back later if needed.
