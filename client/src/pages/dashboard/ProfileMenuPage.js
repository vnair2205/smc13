...
import {
    ...
    FiHelpCircle, FiBook // <-- FIX 1: Imported new icons
} from 'react-icons/fi';
...
// --- FIX 2: Added a separator style for visual grouping ---
...
const ProfileMenuPage = () => {
    ...
    const menuItems = [
        ...
        { path: "/knowledge-base", icon: <FiBook />, name: "Knowledgebase" },
        { path: "/support-tickets", icon: <FiHelpCircle />, name: "Support Tickets" },
        { type: 'separator' }, // <-- Visual separator
        ...
        <PageContainer>
            ...
            <MenuList>
                {menuItems.map((item, index) => {
                    // --- FIX 4: Handle rendering of separators ---
