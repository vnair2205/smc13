                        ...
                        <tbody>
                            {tickets.length > 0 ? tickets.map(ticket => (
                                <tr key={ticket._id}>
                                    ...
                                    <td>
                                        {/* --- FIX: Correct the link to the protected route --- */}
                    ...
                    <MobileCardContainer>
                        {tickets.length > 0 ? tickets.map(ticket => (
                            <TicketCard key={ticket._id} color={priorityColors[ticket.priority]}>
                                ...
                                {/* --- FIX: Correct the link for the mobile view as well --- */}
                                <ViewLink to={`/dashboard/support-tickets/${ticket._id}`}>View Ticket</ViewLink>
                            </TicketCard>
                        )) : (
