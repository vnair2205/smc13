...
import {
    ...
    StepTitle,
    StepDescription,
    NavigationButtons as BaseNavigationButtons,
    NavButton,
    IndexContainer as BaseIndexContainer // <-- FIX 1: Renamed the original import
...
// --- FIX 2: Now this declaration is valid because it extends the renamed import ---
const IndexContainer = styled(BaseIndexContainer)`
    @media (max-width: 768px) {
        background-color: transparent;
        padding: 0;
        border: none;
