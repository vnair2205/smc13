...
const CreditLink = styled.a`
    ...
    @media (max-width: 768px) {
        text-align: center;
        order: 1; /* Credit appears first */
    }
`;


const ChangeVideoButton = styled.button`
    /* Your button styles here - assuming it's similar to NavButton */
    ...
    @media (max-width: 768px) {
        order: 2; /* Change Video button appears second */
    }
`;
...
const VideoNav = styled.div`
    ...
    @media (max-width: 768px) {
        order: 3; /* Prev/Next buttons appear last */
