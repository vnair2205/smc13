            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<DashboardLayout />}>
                ...
                <Route path="/support-tickets" element={<SupportTicketsPage />} />
                 <Route path="support/ticket/:ticketId" element={<UserViewTicketPage />} />
                 <Route path="/dashboard/support/ticket/:ticketId" element={<UserViewTicketPage />} />
                   <Route path="/dashboard/support-tickets" element={<SupportTicketsPage />} />
