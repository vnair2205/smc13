...
const ChatbotContainer = styled.div`
  ...
  /* --- FIX 1: Tweak position slightly for smaller screens --- */
  @media (max-width: 768px) {
    bottom: 15px;
    ${({ $isRTL }) => $isRTL ? css`left: 15px;` : css`right: 15px;`}
  }
`;
...
const SideModal = styled.div`
  ...
  width: 450px; /* Reduced base width for better desktop feel */
  ...
  /* On mobile, make it take up the full screen */
  @media (max-width: 768px) {
    width: 100%;
    ${({ $isOpen, $isRTL }) =>
    $isRTL
