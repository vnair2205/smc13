...
import { FaBook, FaRegLightbulb, FaHourglassHalf, FaCheckCircle } from 'react-icons/fa';
...
const WidgetContainer = styled.div`
  ...
  @media (max-width: 768px) {
    grid-column: span 1; /* Make it take the full width */
    padding: 1.5rem;
  }
`;
...
const ProgressWidget = () => {
    ...
    const stats = [
        ...
        },
        {
            ...
            value: progressData.inProgressCourses,
