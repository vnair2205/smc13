...
// --- FIX: Removed grid layout to stack billing sections vertically ---
...
const InvoiceModal = ({ isOpen, onClose, invoiceDetails }) => {
    ...
    const { plan, user, subtotal, gst, total, endDate, subscriptionId } = invoiceDetails;
    const gstRate = 0.18;
                ...
                <InvoiceContainer ref={invoiceRef}>
                    <InvoiceHeader>
                        ...
                        <InvoiceInfo>
                            ...
                            <p><strong>Date:</strong> {new Date(invoiceDetails.startDate).toLocaleDateString()}</p>
                        </InvoiceInfo>
                    </InvoiceHeader>
                    ...
                    <Section>
                        <BillingDetails>
                            ...
                            <Address>
                                ...
                                <p>{user.email}</p>
                                <p>{formatBillingAddress(user.billingAddress)}</p>
                            </Address>
                        </BillingDetails>
                    </Section>
