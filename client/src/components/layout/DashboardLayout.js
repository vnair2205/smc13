...
const DashboardGrid = styled.div`
  ...
  grid-template-areas:
    ...
    "knowledgebase subscription help-support";
  gap: 2rem;
  padding: 2rem;
...
const KnowledgeBaseWidgetContainer = styled.div`
  grid-area: knowledgebase;
`;

const SubscriptionWidgetContainer = styled.div`
  grid-area: subscription;
`;

const HelpSupportWidgetContainer = styled.div`
  grid-area: help-support;
`;
