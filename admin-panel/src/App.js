...
import AdminViewTicketPage from './pages/AdminViewTicketPage';
...
import PreGenCourseLayout from './components/layout/course/PreGenCourseLayout';
...
import PlanReferrerPage from './pages/PlanReferrerPage';
...
import PregeneratedCoursesReportPage from './pages/PregeneratedCoursesReportPage'; // Add this
import PregeneratedCourseAccessDetailsPage from './pages/PregeneratedCourseAccessDetailsPage'; // Add this
import CourseReportPage from './pages/CourseReportPage';
import CertificateReportPage from './pages/CertificateReportPage';
import ChurnReportPage from './pages/ChurnReportPage';
import DroppedCustomersReportPage from './pages/DroppedCustomersReportPage';
    ...
    <ThemeProvider theme={theme}>
      ...
      <Router>
        <Routes>
          ...
          <Route path="/support-tickets/:ticketId" element={<AdminProtectedRoute><AdminViewTicketPage /></AdminProtectedRoute>} />
          <Route path="/user/:userId/course/:courseId" element={<AdminProtectedRoute><AdminCourseViewPage /></AdminProtectedRoute>} />
          ...
          <Route path="/plan-referrer" element={<AdminProtectedRoute><PlanReferrerPage /></AdminProtectedRoute>} />
          <Route path="/reports" element={<AdminProtectedRoute><ReportsPage /></AdminProtectedRoute>} />
          <Route path="/reports/user" element={<AdminProtectedRoute><UserReportPage /></AdminProtectedRoute>} />
           <Route path="/reports/subscription" element={<AdminProtectedRoute><SubscriptionReportPage /></AdminProtectedRoute>} />
            <Route path="/reports/pregenerated" element={<AdminProtectedRoute><PregeneratedCoursesReportPage /></AdminProtectedRoute>} />
      <Route path="/reports/pregenerated/:id" element={<AdminProtectedRoute><PregeneratedCourseAccessDetailsPage /></AdminProtectedRoute>} />
         <Route path="/reports/courses" element={<AdminProtectedRoute><CourseReportPage /></AdminProtectedRoute>} />
          <Route path="/reports/certificates" element={<AdminProtectedRoute><CertificateReportPage /></AdminProtectedRoute>} />
           <Route path="/reports/churn" element={<AdminProtectedRoute><ChurnReportPage /></AdminProtectedRoute>} />
            <Route path="/reports/dropped-customers" element={<AdminProtectedRoute><DroppedCustomersReportPage /></AdminProtectedRoute>} />


          {/* --- FIX: Course Player Routes now have 'withLayout={false}' to remove the main sidebar --- */}
          
          {/* Route for USER-generated courses */}
          <Route 
            path="/admin/view-course/:courseId" 
            element={<AdminProtectedRoute withLayout={false}><AdminCourseLayout /></AdminProtectedRoute>}
          >
            <Route path="lesson/:subtopicId/:lessonId" element={<AdminLessonContentPage />} />
          </Route>

          {/* Route for PRE-generated courses */}
          <Route 
            path="/admin/course-player/:id" 
            element={<AdminProtectedRoute withLayout={false}><PreGenCourseLayout /></AdminProtectedRoute>}
          >
            <Route path="lesson/:subtopicId/:lessonId" element={<AdminLessonContentPage />} />
          </Route>
            <Route path="/admin/test-users" element={<AdminProtectedRoute><TestUsersPage /></AdminProtectedRoute>} />
