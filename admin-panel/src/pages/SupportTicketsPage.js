...
import SupportCategoryManager from '../components/support/SupportCategoryManager'; // Import the category manager
...
const SupportTicketsPage = () => {
    const [activeTab, setActiveTab] = useState('tickets'); // State to manage tabs
