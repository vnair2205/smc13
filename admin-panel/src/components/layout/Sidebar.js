...
import {
  ...
  FiMessageSquare, FiUsers as FiTeam, FiFileText, FiFile, FiCreditCard, FiUserPlus, FiBarChart2
} from 'react-icons/fi';
...
const MenuList = styled.ul`
  ...
  margin-top: 2rem;
  flex-grow: 1;
  overflow-y: auto; /* This enables vertical scrolling when needed */

  /* Optional: Custom scrollbar styling for a better look */
  &::-webkit-scrollbar {
    width: 8px;
  }
  ...
  return (
    <SidebarContainer>
        ...
        <MenuList>
            ...
            {/* <MenuItem>
                <StyledNavLink to="/admin/test-users">
                    <FiUsers />
            ...
            <MenuItem>
                <StyledNavLink to="/plan-referrer">
                    <FiUserPlus />
                    <span>Plan Referrer</span>
                </StyledNavLink>
            </MenuItem>
            <MenuItem>
